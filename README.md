...
5. Add an attribution footer (*Built with ♥ by Your Name*) with the bundled `site-footer` plugin — opt-in per book, see [themes/README.md](themes/README.md#attribution-footer)
